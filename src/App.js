    ...
    <div className="pt-20 bg-white pb-20 max-h-screen flex overflow-y-scroll justify-center">
      <div className="max-w-screen-lg p-8">
        <div className='relative'>
          <h1 className='text-2xl'>Yash Patil</h1>
          <p className='text-md font-normal pt-8'>I work at OpenAI as a Member of Technical Staff (Resident). I'm currently on leave from Stanford as a sophomore.</p>
          <p className='text-md font-normal pt-4'>I also co-directed <a className="text-blue-700 underline" href="https://www.treehacks.com/" target="_blank">TreeHacks</a> - Stanford's annual hackathon and one of the largest in the world.</p>
          {/* <p className='text-md font-normal pt-4'>I spent last summer building Armadillo Labs - ML based optimizations for ecommerce storefronts with my best friend <a className="text-blue-700 underline" href="https://longo.land/" target="_blank">Daniel</a>. </p> */}
          ...
          <p className='text-md font-normal pt-4'>During the pandemic, I co-founded <a target='_blank' className="text-blue-700 underline" href="https://helpinghands.community">Helping Hands</a> to deliver over 2,000,000 meals.</p>
          <p className='text-md font-normal pt-4 pb-8 text-gray-500'>yash.s.patil [at] gmail [dot] com</p>
