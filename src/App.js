    ...
    <div className="pt-20 pb-20 bg-slate-900 max-h-screen flex overflow-y-scroll justify-center">
      <div className="max-w-screen-lg p-8">
        <div className='relative'>
          ...
          <p className='text-lg text-slate-50 font-normal pt-12'>Hi there! I'm Yash, a freshman at <span className='text-red-400'>Stanford</span> studying Computer Science. At Stanford, I'm co-directing <a className="text-teal-400" href="https://www.treehacks.com/" target="_blank">TreeHacks 2023</a>, Stanford's largest annual hackathon.</p>
          <p className='text-lg text-slate-50 font-normal pt-4'>I'm also fullstack engineer at <a className="text-teal-400" href="https://actively.ai">Actively.ai</a> building software that enables every knowledge worker to be a data scientist. This summer, I'll interning at <a className="text-teal-400" href="https://officetogether.com">OfficeTogether</a> in NYC.</p>
