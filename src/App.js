    ...
    <div className="pt-20 pb-20 bg-slate-900 max-h-screen flex overflow-y-scroll justify-center">
      <div className="max-w-screen-lg p-8">
        <div className='relative'>
          ...
          <p className='text-lg text-slate-50 font-normal pt-12'>Hi there! I'm Yash, a freshman at <span className='text-red-400'>Stanford</span> majoring in Computer Science.</p>
          <p className='text-lg text-slate-50 font-normal pt-4'>Currently, I'm a fullstack engineer at <a className="text-teal-400" href="https://actively.ai">Actively.ai</a> building software that enables every knowledge worker to be a data scientist. I'll also be interning at <a className="text-teal-400" href="https://officetogether.com">OfficeTogether</a> this summer in NYC.</p>
          <p className='text-lg text-slate-50 font-normal pt-4'>During the pandemic, I co-founded <a target='_blank' className="text-teal-400" href="https://helpinghands.community">Helping Hands</a>, a startup that streamlines how food banks and social service organizations deliver food at scale.</p>
          <p className='text-lg text-slate-50 font-normal pt-4 pb-8'>Previously, I've worked as a software engineering intern at <a target='_blank' className="text-teal-400" href="https://bit.io">bit.io</a> and <a className="text-teal-400" href="https://getpei.com">Pei</a> as well as a grid modeling researcher at the <a className="text-teal-400" href="http://www.webberenergygroup.com/people/yash-patil/">Webber Energy Group</a> at UT Austin.</p>
